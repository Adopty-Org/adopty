...
const ReportModal = ({ isOpen, onClose, targetType, targetId, targetName }) => {
  ...
  //const { isSignedIn } = useAuth //useRoleAccess();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        const result = await createSignalement.mutateAsync({
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="w-[90%] max-w-md bg-surface-container-lowest border-4 border-black rounded-xl p-6 shadow-[8px_8px_0px_0px_rgba(26,26,26,1)] z-[9999]"
            >
