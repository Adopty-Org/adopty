...
const Encyclopedie = () => {
  ...
  /*const filterRaces = racesInfo.filter(r => {
                ...
                >
                  <div className="h-60 overflow-hidden relative border-b-4 border-black">
                    ...
                    <div className="absolute top-4 left-4">
                       <span className="bg-white text-primary px-3 py-1 border-2 border-black font-black text-[10px] uppercase tracking-tighter rounded-lg">{breed.espece}</span>
                    </div>
                  </div>
