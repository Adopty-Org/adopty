...
const Profil = () => {
  ...
  return (
    <PageTransition>
            ...
            <FadeIn delay={0.1} className="bg-surface-container-high p-8 rounded-xl border-4 border-black shadow-[8px_8px_0px_0px_rgba(21,66,18,1)]">
              <div className="flex justify-between items-start mb-4">
                <div>
                  ...
                  {/*<p className="font-['Plus_Jakarta_Sans'] font-bold text-secondary text-lg">{animal.race} • {animal.ageLabel}</p>*/}
                </div>
                <button
              ...
              <div className="grid grid-cols-2 gap-4 py-5 border-y-2 border-black/10 my-5">
                {/*[
                  { icon: 'straighten', label: 'Taille', value: `${animal.taille} (${animal.poids})` },
                  { icon: 'health_and_safety', label: 'Santé', value: animal.sante },
      ...
      {/* Modal adoption */}                                                      {/*${animal.nom}*/}
      <Modal isOpen={adoptionOpen} onClose={() => setAdoptionOpen(false)} title={`Adopter `} size="md">
